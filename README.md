...
> **Note:** When downloading by this exact command, you download from `main` branch. Main branch can be unstable, so for higher stability, please use releases instead.
